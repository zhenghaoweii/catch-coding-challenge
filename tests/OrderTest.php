...
class OrderTest extends TestCase
{
    ...
    public function testGetTotalOrderValueWithDiscountInPercentage(): void
    {
        $data = $this->getInitializeData();
        $data['discounts'] = [
